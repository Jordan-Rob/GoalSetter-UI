    ...
    extraReducers: (builder) => {
      builder
        ...
        .addCase(login.fulfilled, (state, action) => {
          // action argument is added since data is received when login is fulfilled
          state.isLoading = false
          state.isSuccess = true
          state.user = action.payload
        ...
        .addCase(login.rejected, (state, action) => {
          // action argument is added since data i received in for of a message when login fails
          state.isLoading = false
          state.isError = true
          state.message = action.payload
          state.user = null
